...
from slm_packager.registry import ModelRegistry, ModelInfo, ModelVariant
...
class TestModelRegistry:
    ...
    def test_get_recommended_variant_no_recommendation(self, mock_registry_file, sample_registry_data):
